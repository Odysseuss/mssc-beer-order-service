...
class BeerOrderManagerImplIT {
    ...
    void testPartialAllocation() throws JsonProcessingException {
        ...
        await().untilAsserted(() -> {
            BeerOrder foundOrder = beerOrderRepository.findById(beerOrder.getId()).get();
            BeerOrderLine line = foundOrder.getBeerOrderLines().iterator().next();
            assertNotEquals(line.getOrderQuantity(), line.getQuantityAllocated());
        });

        BeerOrder allocatedBeerOrder = beerOrderRepository.findById(newBeerOrder.getId()).get();

        assertNotNull(allocatedBeerOrder);
        assertEquals(BeerOrderStatusEnum.PENDING_INVENTORY, allocatedBeerOrder.getOrderStatus());
        allocatedBeerOrder.getBeerOrderLines().forEach(line -> {
            assertNotEquals(line.getOrderQuantity(), line.getQuantityAllocated());
        });
    ...
    void testAllocationFailure() throws JsonProcessingException {
        ...
        BeerOrder failedAllocationBeerOrder = beerOrderRepository.findById(newBeerOrder.getId()).get();
        ...
        failedAllocationBeerOrder.getBeerOrderLines().forEach(line -> {
            assertNotEquals(line.getOrderQuantity(), line.getQuantityAllocated());
        });
        ...
        assertThat(allocationFailureEvent.getOrderId()).isEqualTo(failedAllocationBeerOrder.getId());
    ...
    public void testNewToPickedUp() throws JsonProcessingException {
        ...
        BeerOrder newBeerOrder = beerOrderManager.newBeerOrder(createBeerOrder());
        ...
        beerOrderManager.beerOrderPickedUp(newBeerOrder.getId());
        ...
        BeerOrder pickedUpOrder = beerOrderRepository.findById(newBeerOrder.getId()).get();
    ...
    public void testPendingValidationToCancelled() throws JsonProcessingException {
        ...
        BeerOrder beerOrder = createBeerOrder();
        beerOrder.setCustomerRef("hold-validation");
    ...
    public void testPendingAllocationToCancelled() throws JsonProcessingException {
        ...
        BeerOrder beerOrder = createBeerOrder();
        beerOrder.setCustomerRef("hold-allocation");
